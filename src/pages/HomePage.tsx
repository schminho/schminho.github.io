      ...
      <section className="pt-16">
        <div className="min-h-[60vh] flex items-center justify-center relative">
          <div className="container mx-auto px-6 text-center">
            <h1
              id="about-me"
              className="scroll-mt-20 text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-purple-400 to-pink-500 text-transparent bg-clip-text animate-gradient"
            >
              About Me
            </h1>
        ...
        <div className="container mx-auto px-6 py-20">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Leading digital products from vision to execution,
                      ensuring strategic alignment and seamless delivery.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      ...
                      translating ideas into actionable solutions and ensuring
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">
                      Driving creative solutions with a structured approach -
                      optimizing processes, solving complex challenges, and
          ...
          <div className="py-16 bg-gray-900 mb-20">
            <h2 className="text-2xl font-semibold mb-8 text-center text-gray-100">
              Key Competencies
            </h2>
